...
for (const theme of ['dark', 'light']) {
  ...
  check(`05-post-create-error-${theme} add title`, (await page.getByTestId('member-add').getAttribute('title')) === 'Retry or dismiss the notice about Radar before adding another crewmate.', 'title names the pending crewmate')
  await page.waitForTimeout(400)
